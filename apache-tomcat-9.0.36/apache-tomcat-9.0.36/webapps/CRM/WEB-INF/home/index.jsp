...
<head>
	...
	<!-- toast CSS -->
	<content tag="toastcss">
		<link rel="stylesheet" href='<c:url value="/static/plugins/bower_components/toast-master/css/jquery.toast.css"/>'>
	</content>
	
	<!-- morris CSS -->
	<content tag="morriscss">
		<link rel="stylesheet" href='<c:url value="/static/plugins/bower_components/morrisjs/morris.css"/>'>
	</content>
